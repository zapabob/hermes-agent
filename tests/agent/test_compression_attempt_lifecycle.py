...
class TestWorkerTeardownOnCeiling:
    def test_cooperative_worker_joined_within_grace(self):
        ...
        msgs, prompt = run_compress_context_with_progress_timeout(
            ...
            # Native Windows thread admission can exceed 200ms under CI load;
            # keep the ceiling small while still guaranteeing this cooperative
            # worker starts before the deadline.
