...
DEFAULT_CONFIG = {
    ...
    "web": {
        # Leave the shared selector empty in the distribution defaults.  The
        # registry then chooses CloakBrowser as the first available provider,
        # while an actual value written by `hermes tools` remains an explicit
        # pin and is never silently rotated.
        "backend": "",
