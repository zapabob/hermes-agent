...
def read_file_tool(path: str, offset: int = 1, limit: int = 2000, task_id: str = "default") -> str:
    ...
    try:
        ...
        # and block credential stores under HERMES_HOME.  This must precede
        # backend selection and stat-based checks so denied credential paths
        # never touch a file-operations backend.
