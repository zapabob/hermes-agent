...
contextBridge.exposeInMainWorld('hermesDesktop', {
  ...
  git: {
    ...
    tagList: repoPath => ipcRenderer.invoke('hermes:git:tagList', repoPath),
    stashList: repoPath => ipcRenderer.invoke('hermes:git:stashList', repoPath),
    branchCreate: (repoPath, name, base) => ipcRenderer.invoke('hermes:git:branchCreate', repoPath, name, base),
    branchRename: (repoPath, name, newName) => ipcRenderer.invoke('hermes:git:branchRename', repoPath, name, newName),
    branchDelete: (repoPath, name, force) => ipcRenderer.invoke('hermes:git:branchDelete', repoPath, name, force),
    tagCreate: (repoPath, name, target) => ipcRenderer.invoke('hermes:git:tagCreate', repoPath, name, target),
    tagDelete: (repoPath, name) => ipcRenderer.invoke('hermes:git:tagDelete', repoPath, name),
    stashCreate: (repoPath, message, includeUntracked) =>
      ipcRenderer.invoke('hermes:git:stashCreate', repoPath, message, includeUntracked),
    stashApply: (repoPath, index) => ipcRenderer.invoke('hermes:git:stashApply', repoPath, index),
    stashDrop: (repoPath, index) => ipcRenderer.invoke('hermes:git:stashDrop', repoPath, index),
    fetch: (repoPath, remote) => ipcRenderer.invoke('hermes:git:fetch', repoPath, remote),
    pull: (repoPath, rebase) => ipcRenderer.invoke('hermes:git:pull', repoPath, rebase),
