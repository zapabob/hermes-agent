...
/**
 * Psyche — the pre-upstream Nous palette retained as an explicit preset.
 * The official `nous` entry remains the current GitHub-derived identity;
 * this named variant preserves the fork's deep-blue / warm-cream advantage
 * without changing the meaning of an existing `nous` selection.
 */
export const psycheTheme: DesktopTheme = {
  ...nousTheme,
  name: 'psyche',
  label: 'Psyche',
  description: 'Deep Nous blue with warm Psyche cream accents',
  colors: {
    ...nousTheme.colors,
    background: '#f8faff', foreground: '#17171a', card: '#ffffff', cardForeground: '#17171a',
    muted: 'color-mix(in srgb, #0053FD 5%, #FFFFFF)', mutedForeground: '#666678', popover: '#FFFFFF',
    popoverForeground: '#17171A', primary: '#0053FD', primaryForeground: '#FCFCFC',
    secondary: 'color-mix(in srgb, #0053FD 7%, #FFFFFF)', secondaryForeground: '#242432',
    accent: 'color-mix(in srgb, #0053FD 10%, #FFFFFF)', accentForeground: '#202030',
    border: 'color-mix(in srgb, #0053FD 22%, transparent)', input: 'color-mix(in srgb, #0053FD 30%, transparent)',
    ring: '#0053FD', midground: '#0053FD', composerRing: '#0053FD', destructive: '#C72E4D',
    destructiveForeground: '#FFFFFF', sidebarBackground: '#F3F7FF',
  ...
  darkColors: {
    ...
    background: '#0d2f86', foreground: '#ffe6cb', card: '#12378f', cardForeground: '#ffe6cb',
    muted: '#183f9a', mutedForeground: '#b5c7f3', popover: '#123a96', popoverForeground: '#ffe6cb',
    primary: '#ffe6cb', primaryForeground: '#0d2f86', secondary: '#1b45a4', secondaryForeground: '#e0e8ff',
    accent: '#1540b1', accentForeground: '#f0f4ff', border: '#3158ad', input: '#0b2566',
    ring: '#ffe6cb', midground: '#0053fd', composerRing: '#ffe6cb', destructive: '#c0473a',
    destructiveForeground: '#fef2f2', sidebarBackground: '#09286f', sidebarBorder: '#234a9c',
    userBubble: '#143b91', userBubbleBorder: '#3a63bd'
  }
}
...
export const BUILTIN_THEMES: Record<string, DesktopTheme> = {
  ...
  // Fork-specific skins remain available alongside the official palette
  // presets. They intentionally stay in the same registry so profile/theme
  // resolution and the official accent/retint pipeline see them uniformly.
  hakua: hakuaTheme,
