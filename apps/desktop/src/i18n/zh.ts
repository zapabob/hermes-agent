...
export const zh: Translations = {
  ...
  security: {
    title: '安全中心',
    subtitle: '查看本地扫描证据、定义状态、监控和加密隔离区。',
    refresh: '刷新安全状态',
    enabled: '已启用',
    needsAttention: '需要处理',
    protectionStatus: '保护状态',
    watcher: '用户空间监控',
    automaticQuarantine: '高置信度自动隔离',
    vaultProtection: '隔离区密钥保护',
    engineAvailability: '扫描器可用性',
    activeFeeds: '活动源状态',
    securitySummary: '安全汇总',
    filesScanned: '已扫描文件',
    detections: '检测数',
    quarantineCount: '隔离中',
    lastScan: '上次扫描',
    ...
    updateDefinitions: '更新定义',
    recentEvents: '最近的检测事件',
    encryptedQuarantine: '加密隔离区',
    noEvents: '尚未记录检测事件。',
    noQuarantine: '隔离区中没有文件。',
    unavailable: '不可用',
    time: '时间',
    subject: '对象',
    verdict: '判定',
    ...
    restore: '恢复',
    delete: '删除',
    confirmQuick: '运行快速扫描并仅隔离高置信度检测吗？',
    confirmCustom: '扫描此路径并仅隔离高置信度检测吗？',
    confirmUpdate: '下载、验证并启用当前本地定义吗？',
    confirmRestore: '使用当前定义重新扫描后恢复此项目吗？',
    confirmDelete: '永久删除此加密隔离项目吗？',
    failedLoad: '无法加载安全状态',
    actionFailed: '安全操作失败',
    scanComplete: count => `已完成 ${count} 个文件的扫描。`
  },
