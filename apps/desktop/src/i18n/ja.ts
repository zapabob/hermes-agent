...
export const ja = defineLocale({
    ...
    toolsets: {
      ...
      realProfilePrompt: {
        ...
        prompt: {
          ...
          body: 'Hermes が既定ブラウザプロファイルのスナップショットを使い、ログイン済みの状態でサイトを開けるようにします。',
  ...
  security: {
    title: 'セキュリティセンター',
    subtitle: 'ローカル検査の証跡、定義状態、監視、暗号化隔離を確認します。',
    refresh: 'セキュリティ状態を更新',
    enabled: '有効',
    ...
    vaultProtection: '隔離鍵の保護',
    engineAvailability: 'スキャナーの利用状況',
    activeFeeds: '有効なフィード状態',
    securitySummary: 'セキュリティ集計',
    ...
    quickScan: 'クイック検査',
    customScan: 'カスタム検査',
    pathPlaceholder: 'ファイルまたはディレクトリの絶対パス',
    updateDefinitions: '定義を更新',
    recentEvents: '最近の検出イベント',
    encryptedQuarantine: '暗号化隔離',
    noEvents: '検出イベントは記録されていません。',
    noQuarantine: '隔離中のファイルはありません。',
    unavailable: '利用不可',
    time: '日時',
    subject: '対象',
    verdict: '判定',
    ...
    restore: '復元',
    delete: '削除',
    confirmQuick: 'クイック検査を実行し、高信頼度の検出だけを隔離しますか？',
    confirmCustom: 'このパスを検査し、高信頼度の検出だけを隔離しますか？',
    confirmUpdate: '最新のローカル定義を取得、検証して有効化しますか？',
    confirmRestore: '現在の定義で再検査してから、この項目を復元しますか？',
    confirmDelete: 'この暗号化隔離項目を完全に削除しますか？',
    failedLoad: 'セキュリティ状態を読み込めませんでした',
    actionFailed: 'セキュリティ操作に失敗しました',
    scanComplete: count => `${count} ファイルの検査が完了しました。`
  },
