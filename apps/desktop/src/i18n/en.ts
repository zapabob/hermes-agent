...
export const en: Translations = {
  ...
  security: {
    ...
    subtitle: 'Local scanner evidence, definition state, monitoring, and encrypted quarantine.',
    ...
    vaultProtection: 'Vault key protection',
    engineAvailability: 'Scanner availability',
    activeFeeds: 'Active feed status',
    ...
    pathPlaceholder: 'Absolute file or directory path',
    updateDefinitions: 'Update definitions',
    recentEvents: 'Recent detection events',
    encryptedQuarantine: 'Encrypted quarantine',
    noEvents: 'No detection events recorded.',
    noQuarantine: 'No files are in quarantine.',
    unavailable: 'Unavailable',
    time: 'Time',
    subject: 'Subject',
    verdict: 'Verdict',
    ...
    restore: 'Restore',
    delete: 'Delete',
    confirmQuick: 'Run a quick scan and quarantine only high-confidence detections?',
    confirmCustom: 'Scan this path and quarantine only high-confidence detections?',
    confirmUpdate: 'Download, validate, and activate current local definitions?',
    confirmRestore: 'Restore this item after rescanning it with current definitions?',
    confirmDelete: 'Permanently delete this encrypted quarantine item?',
    failedLoad: 'Security status failed to load',
    actionFailed: 'Security action failed',
    scanComplete: count => `Scan finished for ${count} file${count === 1 ? '' : 's'}.`
  },
