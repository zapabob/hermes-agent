...
export const ar = defineLocale({
  ...
  settings: {
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'تم تحديث وقت تشغيل Hermes، لكن تطبيق سطح المكتب نفسه لا يزال إصدارًا قديمًا — لن تظهر ميزات الواجهة الجديدة (مثل Bot Mode) حتى يتم تحديث التطبيق. شغّل التحديث أدناه لإعادة بناء التطبيق. إذا لم يختفِ هذا التحذير، فاتبع تعليمات التثبيت من المصدر الخاصة بالمشروع الفرعي.',
      bundleOutOfSyncAction: 'عرض تعليمات التثبيت من المصدر',
      updates: 'التحديثات',
  ...
  statusStack: {
    ...
    coding: {
      ...
      changes: 'التغييرات',
      history: 'السجل',
      commitHistory: 'سجل الالتزامات',
      noHistory: 'لا توجد التزامات',
      ...
      branches: 'الفروع',
      tags: 'الوسوم',
      stashes: 'التخزين المؤقت',
      noBranches: 'لا توجد فروع',
      noTags: 'لا توجد وسوم',
      noStashes: 'لا يوجد تخزين مؤقت',
      checkedOut: 'مُخرج',
      fetch: 'جلب',
      pull: 'سحب',
      createBranch: 'فرع جديد',
      createBranchDesc: 'إنشاء فرع جديد من HEAD الحالي.',
      renameBranch: 'إعادة تسمية الفرع',
      renameBranchDesc: (name: string) => `إعادة تسمية ${name}.`,
      deleteBranch: 'حذف الفرع',
      deleteBranchConfirm: (name: string) => `حذف الفرع ${name}؟ لا يمكن التراجع عن هذا الإجراء.`,
      createTag: 'وسم جديد',
      createTagDesc: 'إنشاء وسم جديد عند HEAD الحالي.',
      deleteTag: 'حذف الوسم',
      deleteTagConfirm: (name: string) => `حذف الوسم ${name}؟ لا يمكن التراجع عن هذا الإجراء.`,
      stashChanges: 'تخزين التغييرات',
      stashChangesDesc: 'تخزين جميع التغييرات غير الملتزمة.',
      stashMessage: 'الرسالة',
      stashMessagePlaceholder: 'رسالة التخزين (اختياري)',
      applyStash: 'تطبيق التخزين',
      dropStash: 'إسقاط التخزين',
      dropStashConfirm: (id: string) => `إسقاط ${id}؟ لا يمكن التراجع عن هذا الإجراء.`,
