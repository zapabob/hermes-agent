...
export function getMcpOAuthFlow(flowId: string, scope?: ProfileScope): Promise<McpOAuthFlow> {
  return window.hermesDesktop.api<McpOAuthFlow>({
    ...capabilityScoped(scope),
...
export function cancelMcpOAuthFlow(flowId: string, scope?: ProfileScope): Promise<{ ok: boolean; status: string }> {
...
export function removeMcpServer(name: string, scope?: ProfileScope): Promise<{ ok: boolean }> {
...
export function setMcpServerEnabled(name: string, enabled: boolean, scope?: ProfileScope): Promise<{ ok: boolean }> {
  return hermesApi<{ ok: boolean }>({
    ...capabilityScoped(scope),
...
export function getMcpCatalog(scope?: ProfileScope): Promise<McpCatalogResponse> {
